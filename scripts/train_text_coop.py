...
- With discrete comm: gradients can't reach Agent A's LLM at all
"""
...
from src.env_text_coop import TextCoopDataset, TextCoopSample
...
def run_experiment(
    ...
    train_data = TextCoopDataset("train", seed=seed)
    val_data = TextCoopDataset("val", seed=seed)
...
def main():
    ...
    parser.add_argument("--output", type=str, default="results/text_coop_comparison.json")
